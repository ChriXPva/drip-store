  ...
  return (
    <section className="relative overflow-hidden py-3 px-4 md:px-8 lg:px-16 bg-[#f0f0f0]">
      <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 
        w-100 h-150 md:w-125 md:h-150
        bg-linear-to-t from-[#f0f0f0] to-white blur-2xl z-0">
      </div>
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-[500px_auto] items-center gap-10 max-w-7xl mx-auto min-h-100">
        ...
        <div className="relative flex justify-center lg:justify-end items-center w-full">
          ...
          <img
            ...
            className="hidden md:block absolute -right-10 top-[10%] w-35 h-35 pointer-events-none"
          />
        </div>
      </div>
